...
namespace BaboOnLite {
    public class _Prefabs
    {
        ...
        //ADS
        [MenuItem("GameObject/UI/BaboOnLite/Ads")]
        private static void InstanciarAds(MenuCommand selecciondo)
        {
            Prefabs.Elemento("Componentes/_ads.prefab", selecciondo, true);
        }
        //TEXTOS
        [MenuItem("GameObject/UI/BaboOnLite/Textos")]
        private static void InstanciarTextos(MenuCommand selecciondo)
        {
            Prefabs.Elemento("Componentes/_text.prefab", selecciondo, true);
        }
        //CONTROLADOR
